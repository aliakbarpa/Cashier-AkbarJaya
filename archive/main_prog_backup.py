...
class LargeCompletionDialog(QDialog):
    ...
    def __init__(self, parent, payment, change):
        ...
        # --- FIXED VERSION: allow resizing instead of fixed geometry ---
        self.resize(900, 800)
        self.setMinimumHeight(800)
        self.setSizeGripEnabled(True)
        self.move(250, 150)  # keep same screen position
...
"""
    ...
    def checkout(self):
        ...
        customer_name = customer_name if (ok and customer_name.strip()) else "Customer"
