...
from report import generate_sales_report  # New report feature
...
class AkbarCashier(QMainWindow):
    def __init__(self):
        ...
        title_font = QFont("Arial", 50, QFont.Weight.Bold)
        ...
        cashier_font = QFont("Arial", 40, QFont.Weight.Bold)
...
class AkbarCashier(QMainWindow):
    def __init__(self):
        ...
        datetime_font = QFont("Arial", 14)
        self.datetime_label.setFont(datetime_font)
        self.datetime_label.setStyleSheet("color: #555555; margin-bottom: 5px;")
        self.main_layout.addWidget(self.datetime_label)
